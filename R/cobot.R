...
#'
#' @param formula an object of class \code{\link[Formula]{Formula}} (or one
#'     that can be coerced to that class): a symbolic description of the
#'     model to be fitted.  The details of model specification are given
#'     under \sQuote{Details}.
#' @param link The link family to be used for ordinal models of both \var{X}
...
#' @param link.y The link function to be used for a model of the second
...
#' @param fisher logical; if \code{TRUE}, Fisher transformation and delta
...
#' @references Li C and Shepherd BE, Test of association between two ordinal
...
#'     outcomes. Biometrika 2012; 99:473-480
#' @import Formula
#' @importFrom stats na.fail model.matrix contrasts model.frame
#'     model.response cor
#' @export
#' @seealso \code{\link[Formula]{Formula}}, \code{\link{as.data.frame}}
#' @include newPolr.R
#' @include diagn.R
#' @include GKGamma.R
#' @include pgumbel.R
